...
namespace Test
{
    ...
    public class Step2_TetrominoesTest
    {
        ...
        [TestMethod]
        public void I_shape_first_orientation()
        {
            // act
            Tetromino I_SHAPE = CreateIshape();

            // assert
            Assert.AreEqual(I_SHAPE.ToString(),
                "....\n" +
                "TTTT\n" +
                "....\n" +
                "....\n"
        ...
        [TestMethod]
        public void I_shape_rotated_right()
        {
            // arrange
            Tetromino I_SHAPE = CreateIshape();

            // act
            Tetromino shape = I_SHAPE.RotateRight();
        ...
        [TestMethod]
        public void I_shape_rotated_left()
        {
            // arrange
            Tetromino I_SHAPE = CreateIshape();

            // act
            Tetromino shape = I_SHAPE.RotateLeft();
        ...
        [TestMethod]
        public void I_shape_looped_around_right()
        {
            // arrange
            Tetromino I_SHAPE = CreateIshape();

            // act
            Tetromino shape = I_SHAPE;
            shape = shape.RotateRight();
            shape = shape.RotateRight();
            shape = shape.RotateRight();
            shape = shape.RotateRight();
            ...
            // assert
            Assert.AreEqual(shape.ToString(), I_SHAPE.ToString());
        }

        [TestMethod]
        public void I_shape_looped_around_left()
        {
            // arrange
            Tetromino I_SHAPE = CreateIshape();
